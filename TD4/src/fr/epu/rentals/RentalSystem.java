 ...
 */
    ...
    public List<T> searchItems(String description) {
        final List<T> matchingItems = new ArrayList<>();
        ...
        public List<T> findAvailableMatches(String description, LocalDate beginDate, LocalDate endDate) throws NoSuchItemException {
